...
from .algorithms import get_rate_limiter, BaseRateLimiter
...
def rate_limit(
    ...
    **limiter_kwargs
    ...
    Args:
        ...
        algorithm: Rate limiting algorithm ("sliding_window", "token_bucket", "fixed_window", "sliding_counter")
...
def throttle(
    ...
    **decorator_kwargs
    ...
    Args:
        rate: Rate string in format "limit/period" (e.g., "100/hour", "10/minute", "1/second")
    ...
    try:
        ...
        raise ValueError(f"Invalid rate format: {rate}. Use 'limit/period' format.") from e
